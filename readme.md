Спасибо за уточнение структуры проекта! На основе предоставленной структуры я обновлю файл `README.md`, чтобы он соответствовал вашей текущей организации проекта.
